...
<link rel="stylesheet" href="/GameFighter/css/member/memberSheet.css">
<script src="/GameFighter/javascript/jquery-3.7.1.min.js"></script>
<script src="/GameFighter/javascript/member/MemberSheet.js"></script>
<title>會員管理</title>
</head>
<body>
    <dialog>
    ...
    <main id="allpage">
        <header>
            <nav>
                <ul class="menu">
                    <li><a href="/GameFighter/MemberManage" class="active">會員管理</a></li>
                    <li><a target="_blank" href="/GameFighter/Homepage">遊戲管理</a></li>
                    <li><a target="_blank" href="/GameFighter/GetAllGames">交易管理</a></li>
                    <li><a target="_blank" href="/GameFighter/view/texts/GetText.html">論壇管理</a></li>
                    <li><a target="_blank" href="/GameFighter/AllUsers">伴遊管理</a></li>
                    <li><a target="_blank" href="/GameFighter/GetAllAct">活動管理</a></li>
                    <li class="right"><a href="/GameFighter/dynamicView/member/Home.jsp">回到首頁</a></li>
                </ul>
            </nav>
        </header>
