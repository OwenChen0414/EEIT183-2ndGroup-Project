...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="/GameFighter/css/member/Login.css">
<script src="/GameFighter/javascript/jquery-3.7.1.min.js"></script>
<script src="/GameFighter/javascript/member/Login.js"></script>
<title>登入</title>
</head>
<body>
    <section>
        <div class="page">
            <h2>登入</h2>
            <form action="/GameFighter/Login" method="post">
                <p>帳號:</p>
