...
<link rel="stylesheet" type="text/css"
	href="/PlayCentric/css/event/event01.css">
</head>
<body>
	<!-- 其他功能的連結 -->
	<div class="box">
	...
	<div class="container">
		...
		<form action="/PlayCentric/event/getEvent" method="get">
			<table style="margin: 0 auto;">
				<tr>
					<td>查詢條件</td>
					<td><select name="criteria" class="custom-select">
