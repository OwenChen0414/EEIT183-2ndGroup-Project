...
<body>
    ...
    <form method="post" action="${pageContext.request.contextPath}/insertProp" class="center" enctype="multipart/form-data">
        ...
        <input type="file" name="propImage" id="propImagePath" required>
