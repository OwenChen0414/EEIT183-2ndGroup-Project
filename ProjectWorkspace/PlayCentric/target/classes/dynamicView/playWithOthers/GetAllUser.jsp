		...
		<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
			...
			<body>
				...
				<div class="modal" id="modalForm">
					<form method="post" action="${pageContext.request.contextPath}/DemoInsertPwUser"
				...
				<div class="content">
					...
					<div class="outside">
						<div class="selectButtonDiv">
							<form method="post" action="${pageContext.request.contextPath}/DemofuzzySearch">
								...
								<table border="1" style="background-color: white">
									...
									<c:forEach items="${pwUsers}" var="PwUser">
										...
										<tr>
											...
											<td>
												<form action="${pageContext.request.contextPath}/DemoSelectOneUser"
											...
											<td>
												<form action="${pageContext.request.contextPath}/DemoDeletePwUser"
													method="get" style="display: inline;"
