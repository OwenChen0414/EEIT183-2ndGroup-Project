...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/announcement/get-insert-announcement.css?v=1.0">
...
<body>
    ...
    <script src="${pageContext.request.contextPath}/js/mouse.js?v=1.0?v=1.0"></script>
</body>
