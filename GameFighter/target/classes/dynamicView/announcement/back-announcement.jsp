...
<body>
    <header>
        ...
        <aside id="contentTag">
            <ul id="leftList">
                <li id="selected"><a href="${pageContext.request.contextPath}/BackAnnouncement">公告管理</a></li>
                <li>會員管理</li>
                <li>討論區文章管理</li>
                <li>討論區留言管理</li>
    ...
    <main>
        <article>
            ...
            <div id="content">
                    ...
                    <a href="${pageContext.request.contextPath}/GetInsertAnnouncement" id="plus"><i class="fa-solid fa-plus"></i></a>
            </section>
        </article>
    </main>
