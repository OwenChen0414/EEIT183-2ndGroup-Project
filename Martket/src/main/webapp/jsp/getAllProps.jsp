...
<body>
  <header>
    <div class="search">
      <h1>遊戲道具交易後台</h1>
      <form action="${pageContext.request.contextPath}/GetAllProps">
      ...
      <form action="${pageContext.request.contextPath}/SearchProp">
    ...
    <nav>
      ...
      <ul>
        <li><a href="http://localhost:8080/Martket/GetAllProps?game=${props[0].gameId}">道具總覽</a></li>
      ...
      <table>
        ...
        <c:forEach items="${props}" var="prop">
          <tr>
            ...
            <td>
              <form action="${pageContext.request.contextPath}/GetPropData">
                ...
                <input type="hidden" name="propImagePath" value="${prop.propImagePath}" />
