        ...
        <header>
          ...
          <%-- 因道具表單沒有設計遊戲名稱欄位，只能拿遊戲ID編號來一一比對取得遊戲名稱 --%>
            ...
            <h2 class="title2">${selectName}</h2>
              <ul>
                <li><a href="http://localhost:8080/Martket/GetAllProps?game=${props[0].gameId}">道具總覽</a>
                </li>
                ...
                <form calss="OrdersData">
                 ...
                 <c:set var="prop" value="${SelectedProps[status.index]}"/>
                    <tr>
                      ...
                      <td><img src="images/${prop.propImagePath}" alt="${prop.propImagePath}" width="40" height="60" disabled ></td>
